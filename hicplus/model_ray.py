...
# Instead of 3 layers, make this a 4 layer nn.
conv2d1_filters_numbers = 8
conv2d1_filters_size = 9
conv2d2_filters_numbers = 8
conv2d2_filters_size = 9
conv2d3_filters_numbers = 8
conv2d3_filters_size = 1
conv2d4_filters_numbers = 1
conv2d4_filters_size = 5
...
class Net(nn.Module):
    def __init__(self, D_in, D_out):
        ...
        self.conv3 = nn.Conv2d(conv2d2_filters_numbers, conv2d3_filters_numbers, conv2d3_filters_size)
        self.conv4 = nn.Conv2d(conv2d2_filters_numbers, 1, conv2d3_filters_size)
